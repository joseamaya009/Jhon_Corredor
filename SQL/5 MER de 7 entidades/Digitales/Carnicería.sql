...
(1, 'Res', 'Lomo', 35000.00, 20),
(2, 'Cerdo', 'Costilla', 25000.00, 15),
(3, 'Pollo', 'Pechuga', 18000.00, 30);

INSERT INTO Sucursal VALUES 
(1, 'Sucursal Central', 'Cra 10 #20-30', '3001234567'),
(2, 'Sucursal Norte', 'Av 45 #67-89', '3019876543'),
(3, 'Sucursal Sur', 'Cll 100 #50-60', '3025557890');
...
(1, '2025-07-01', 'Mostrador', 70000.00, 1),
(2, '2025-07-05', 'Domicilio', 25000.00, 2),
(3, '2025-07-10', 'Mostrador', 36000.00, 3);

INSERT INTO Cliente VALUES 
(1, 'Laura', 'Martínez', '3111222233', 1),
...
SELECT tipo_producto, AVG(precio) AS promedio
FROM Producto
...
DELETE FROM Sucursal WHERE nombre_sucursal = 'Sucursal Norte';
