...
(1, 'Martillo', 'Herramienta', 25000.00, 30),
(2, 'Pintura', 'Material', 35000.00, 20),
(3, 'Tornillos', 'Accesorio', 5000.00, 200);
...
(2, '2025-07-05', 'Domicilio', 35000.00, 2),
(3, '2025-07-10', 'Mostrador', 5000.00, 3);
...
SELECT * FROM Producto
WHERE tipo_producto <> 'Herramienta';
