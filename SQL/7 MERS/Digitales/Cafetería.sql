...
(1, 'Café americano', 'Bebida', 3500.00, 100),
(2, 'Té verde', 'Bebida', 2500.00, 80),
(3, 'Croissant', 'Repostería', 4000.00, 60);
...
(1, 'Ana', 'García', 'Barista'),
(2, 'Carlos', 'Pérez', 'Cajero'),
(3, 'Marta', 'López', 'Mesera');
...
DELETE FROM Venta WHERE total < 3000;
